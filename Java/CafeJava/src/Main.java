public class Main {
    public static void main(String[] args) {
        ...
        if (isReadyOrder4 == true){
            ...
            System.out.println(customer4 + pendingMessage + displayTotalMessage + cappuccino);
        }
        ...
        if (isReadyOrder2 == true){
            ...
            System.out.println(customer2 + pendingMessage + displayTotalMessage + latte*2);
        }

        System.out.println(generalGreeting + customer3);
        System.out.println(customer3 + "you owe us " + (latte-dripCoffee));
    }
}